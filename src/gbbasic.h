...
#	define GBBASIC_VER_MINOR 8
#	define GBBASIC_VER_REVISION 2
...
// The minimum height for scaling window.
#ifndef GBBASIC_WINDOW_SCALE_MIN_HEIGHT
#	define GBBASIC_WINDOW_SCALE_MIN_HEIGHT 180
#endif /* GBBASIC_WINDOW_SCALE_MIN_HEIGHT */
...
#	define GBBASIC_PROJECT_FILE_FILTER { \
			"GB BASIC files (*." GBBASIC_RICH_PROJECT_EXT ", *." GBBASIC_PLAIN_PROJECT_EXT ")", \
				"*." GBBASIC_RICH_PROJECT_EXT " *." GBBASIC_PLAIN_PROJECT_EXT, \
			"ROM files (*." GBBASIC_CLASSIC_ROM_EXT ", *." GBBASIC_COLORED_ROM_EXT ", *.zip" ")", \
				"*." GBBASIC_CLASSIC_ROM_EXT " *." GBBASIC_COLORED_ROM_EXT " *.zip", \
			"Supported project files (*." GBBASIC_RICH_PROJECT_EXT ", *." GBBASIC_PLAIN_PROJECT_EXT ", *." GBBASIC_CLASSIC_ROM_EXT ", *." GBBASIC_COLORED_ROM_EXT ", *.zip" ")", \
				"*." GBBASIC_RICH_PROJECT_EXT " *." GBBASIC_PLAIN_PROJECT_EXT " *." GBBASIC_CLASSIC_ROM_EXT " *." GBBASIC_COLORED_ROM_EXT " *.zip", \
			"All files (*.*)", "*" \
		}
