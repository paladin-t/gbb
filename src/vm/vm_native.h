...
#ifndef USE_BLIT_TEXT_FUNCTIONS
#   define USE_BLIT_TEXT_FUNCTIONS 1
#endif /* USE_BLIT_TEXT_FUNCTIONS */
#ifndef USE_SGB_FUNCTIONS
#   define USE_SGB_FUNCTIONS 1
#endif /* USE_SGB_FUNCTIONS */
#ifndef USE_ERROR_FUNCTIONS
#   define USE_ERROR_FUNCTIONS 1
...
BOOLEAN blit_text(POINTER THIS, BOOLEAN start, UINT16 * stack_frame) OLDCALL BANKED; // INVOKABLE.
#endif /* USE_BLIT_TEXT_FUNCTIONS */
