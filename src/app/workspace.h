...
#ifndef WORKSPACE_EXAMPLE_PROJECT_FILTER
#	define WORKSPACE_EXAMPLE_PROJECT_FILTER \
		"*." GBBASIC_RICH_PROJECT_EXT ";" \
		"*." GBBASIC_PLAIN_PROJECT_EXT ";" \
		"*." GBBASIC_CLASSIC_ROM_EXT ";" \
		"*." GBBASIC_COLORED_ROM_EXT ";" \
		"*.zip"
#endif /* WORKSPACE_EXAMPLE_PROJECT_FILTER */
...
public:
	...
	typedef std::function<void(void)> KernelDocumentViewedHandler;
